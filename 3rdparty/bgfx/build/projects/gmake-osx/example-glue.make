...
ifeq ($(config),debug32)
  OBJDIR              = ../../osx32_clang/obj/x32/Debug/example-glue
...
ifeq ($(config),release32)
  OBJDIR              = ../../osx32_clang/obj/x32/Release/example-glue
  TARGETDIR           = ../../osx32_clang/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../osx64_clang/obj/x64/Debug/example-glue
...
ifeq ($(config),release64)
  OBJDIR              = ../../osx64_clang/obj/x64/Release/example-glue
  TARGETDIR           = ../../osx64_clang/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
