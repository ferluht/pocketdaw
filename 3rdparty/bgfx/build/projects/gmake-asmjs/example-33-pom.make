...
ifeq ($(config),debug32)
  OBJDIR              = ../../asmjs/obj/x32/Debug/example-33-pom
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-33-pomDebug.bc
...
ifeq ($(config),release32)
  OBJDIR              = ../../asmjs/obj/x32/Release/example-33-pom
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-33-pomRelease.bc
...
ifeq ($(config),debug64)
  OBJDIR              = ../../asmjs/obj/x64/Debug/example-33-pom
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-33-pomDebug.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release64)
  OBJDIR              = ../../asmjs/obj/x64/Release/example-33-pom
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-33-pomRelease.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),debug)
  OBJDIR              = ../../asmjs/obj/Debug/example-33-pom
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-33-pomDebug.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release)
  OBJDIR              = ../../asmjs/obj/Release/example-33-pom
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-33-pomRelease.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
