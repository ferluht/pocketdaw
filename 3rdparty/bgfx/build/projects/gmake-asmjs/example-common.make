...
ifeq ($(config),debug32)
  OBJDIR              = ../../asmjs/obj/x32/Debug/example-common
  TARGETDIR           = ../../asmjs/bin
  ...
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/asmjs" -m32
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS)
...
ifeq ($(config),release32)
  OBJDIR              = ../../asmjs/obj/x32/Release/example-common
  TARGETDIR           = ../../asmjs/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../asmjs/obj/x64/Debug/example-common
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/asmjs" -m64
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS)
...
ifeq ($(config),release64)
  OBJDIR              = ../../asmjs/obj/x64/Release/example-common
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
...
ifeq ($(config),debug)
  OBJDIR              = ../../asmjs/obj/Debug/example-common
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/asmjs"
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS)
...
ifeq ($(config),release)
  OBJDIR              = ../../asmjs/obj/Release/example-common
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
