...
ifeq ($(config),debug32)
  OBJDIR              = ../../asmjs/obj/x32/Debug/example-glue
  TARGETDIR           = ../../asmjs/bin
...
ifeq ($(config),release32)
  OBJDIR              = ../../asmjs/obj/x32/Release/example-glue
  TARGETDIR           = ../../asmjs/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../asmjs/obj/x64/Debug/example-glue
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-glueDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
...
ifeq ($(config),release64)
  OBJDIR              = ../../asmjs/obj/x64/Release/example-glue
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
...
ifeq ($(config),debug)
  OBJDIR              = ../../asmjs/obj/Debug/example-glue
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-glueDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
...
ifeq ($(config),release)
  OBJDIR              = ../../asmjs/obj/Release/example-glue
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
