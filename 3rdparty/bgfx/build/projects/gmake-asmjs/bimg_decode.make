...
ifeq ($(config),debug32)
  OBJDIR              = ../../asmjs/obj/x32/Debug/bimg_decode
  TARGETDIR           = ../../asmjs/bin
...
ifeq ($(config),release32)
  OBJDIR              = ../../asmjs/obj/x32/Release/bimg_decode
  TARGETDIR           = ../../asmjs/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../asmjs/obj/x64/Debug/bimg_decode
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty"
...
ifeq ($(config),release64)
  OBJDIR              = ../../asmjs/obj/x64/Release/bimg_decode
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty"
...
ifeq ($(config),debug)
  OBJDIR              = ../../asmjs/obj/Debug/bimg_decode
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty"
...
ifeq ($(config),release)
  OBJDIR              = ../../asmjs/obj/Release/bimg_decode
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty"
