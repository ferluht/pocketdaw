...
ifeq ($(config),debug32)
  OBJDIR              = ../../asmjs/obj/x32/Debug/example-28-wireframe
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-28-wireframeDebug.bc
...
ifeq ($(config),release32)
  OBJDIR              = ../../asmjs/obj/x32/Release/example-28-wireframe
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-28-wireframeRelease.bc
...
ifeq ($(config),debug64)
  OBJDIR              = ../../asmjs/obj/x64/Debug/example-28-wireframe
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-28-wireframeDebug.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release64)
  OBJDIR              = ../../asmjs/obj/x64/Release/example-28-wireframe
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-28-wireframeRelease.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),debug)
  OBJDIR              = ../../asmjs/obj/Debug/example-28-wireframe
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-28-wireframeDebug.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release)
  OBJDIR              = ../../asmjs/obj/Release/example-28-wireframe
  TARGETDIR           = ../../asmjs/bin
  TARGET              = $(TARGETDIR)/example-28-wireframeRelease.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
