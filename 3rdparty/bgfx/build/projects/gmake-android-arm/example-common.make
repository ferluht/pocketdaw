...
ifeq ($(config),debug32)
  ...
  INCLUDES           += -I"$(ANDROID_NDK_ROOT)/sources/cxx-stl/llvm-libc++/include" -I"${ANDROID_NDK_ROOT}/sysroot/usr/include" -I"$(ANDROID_NDK_ROOT)/sources/android/native_app_glue" -I"$(ANDROID_NDK_ROOT)/sysroot/usr/include/arm-linux-androideabi" -I"../../../../bx/include" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty"
...
ifeq ($(config),debug64)
  ...
  ALL_OBJCPPFLAGS    += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -ffast-math -fomit-frame-pointer -g -m64 -std=c++14 -fno-rtti -fno-exceptions -fPIC -no-canonical-prefixes -Wa,--noexecstack -fstack-protector-strong -ffunction-sections -Wunused-value -Wundef -gcc-toolchain $(ANDROID_NDK_ARM) --sysroot=$(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm -target armv7-none-linux-androideabi -mthumb -march=armv7-a -mfloat-abi=softfp -mfpu=neon
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"$(ANDROID_NDK_ROOT)/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a" -L"." -m64 -nostdlib -no-canonical-prefixes -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -gcc-toolchain $(ANDROID_NDK_ARM) --sysroot=$(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm $(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm/usr/lib/crtbegin_so.o $(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm/usr/lib/crtend_so.o -target armv7-none-linux-androideabi -march=armv7-a -Wl,--fix-cortex-a8
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS) -lc -ldl -lm -landroid -llog -lc++_shared -lgcc
...
ifeq ($(config),debug)
  ...
  ALL_OBJCPPFLAGS    += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -ffast-math -fomit-frame-pointer -g -std=c++14 -fno-rtti -fno-exceptions -fPIC -no-canonical-prefixes -Wa,--noexecstack -fstack-protector-strong -ffunction-sections -Wunused-value -Wundef -gcc-toolchain $(ANDROID_NDK_ARM) --sysroot=$(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm -target armv7-none-linux-androideabi -mthumb -march=armv7-a -mfloat-abi=softfp -mfpu=neon
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"$(ANDROID_NDK_ROOT)/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a" -L"." -nostdlib -no-canonical-prefixes -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -gcc-toolchain $(ANDROID_NDK_ARM) --sysroot=$(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm $(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm/usr/lib/crtbegin_so.o $(ANDROID_NDK_ROOT)/platforms/android-24/arch-arm/usr/lib/crtend_so.o -target armv7-none-linux-androideabi -march=armv7-a -Wl,--fix-cortex-a8
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS) -lc -ldl -lm -landroid -llog -lc++_shared -lgcc
